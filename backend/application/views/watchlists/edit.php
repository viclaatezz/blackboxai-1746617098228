...
<body>
    ...
    <?php echo form_open('watchlists/update/'.$watchlist['id']); ?>
        <label for="portfolio_id">Portfolio:</label>
        <select name="portfolio_id" id="portfolio_id">
            <?php foreach ($portfolios as $portfolio): ?>
                <option value="<?php echo $portfolio['id']; ?>" <?php echo set_select('portfolio_id', $portfolio['id'], ($watchlist['portfolio_id'] == $portfolio['id'])); ?>>
        ...
        <select name="coin_id" id="coin_id">
            <?php foreach ($coins as $coin): ?>
                <option value="<?php echo $coin['id']; ?>" <?php echo set_select('coin_id', $coin['id'], ($watchlist['coin_id'] == $coin['id'])); ?>>
